        ...
        <div className='footer__menu'>
          ...
          <ul className='footer__menu-list'>
            <li className='footer__menu-item'>
              <ul className='footer__submenu-list'>
                <li className='footer__submenu-item'>Избранное</li>
                <li className='footer__submenu-item'>Корзина</li>
                <li className='footer__submenu-item'>Контакты</li>
              </ul>
            </li>
            <li className='footer__menu-item'>
              <ul className='footer__submenu-list'>
                <li className='footer__submenu-item'>Условия сервиса</li>
                <li className='footer__submenu-item footer__submenu-item--accent'>
                  <svg
                    width='20'
                    height='20'
                    viewBox='0 0 20 20'
                  ...
                  <span className='footer__submenu-accent'>Рус</span> Eng
                </li>
              </ul>
            </li>
            ...
            <li className='footer__menu-item'>
              <ul className='footer__submenu-list'>
                <li className='footer__submenu-item'>
                  <a href='https://t.me/+123456789'>
                    <svg
                      width='31'
                      height='31'
                      viewBox='0 0 31 31'
